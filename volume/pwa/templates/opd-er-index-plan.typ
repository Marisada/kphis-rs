...
#import "templates/utils.typ": api, get_patient_main, date_th, month_th, time_th, parse_d_t, parse_d, watermarks
// PRELUDE
...
#if order == none {order = if pt.opd_er_order_master_id == none {()} else {json(api + "opd-er/order/item?opd_er_order_master_id=" + str(pt.opd_er_order_master_id) + "&view_by=doctor")}}
// PREPARED FUNCTIONS
