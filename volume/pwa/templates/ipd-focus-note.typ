#import "templates/utils.typ": api, get_patient_main, date_th, time_th, explode_imgs, square_bracket_to_span, watermark
// PRELUDE
...
#if note == none {note = json(api + "ipd/focus-note-an/" + data.id)}
// PREPARED FUNCTIONS
