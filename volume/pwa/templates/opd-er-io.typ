#import "templates/utils.typ": api, get_patient_main, month_th, date_th, time_th, parse_d, thousands, square_bracket_to_span, watermark
// PRELUDE
...
#if io_data == none {io_data = if pt.opd_er_order_master_id == none {()} else {json(api + "opd-er/io?opd_er_order_master_id=" + str(pt.opd_er_order_master_id))}}
// PREPARED FUNCTIONS
...
#let item(io) = (cell(1,1,date_th(io.io_date)),cell(1,1,time_th(io.io_time)),
  cell(1,1,parenteral(io.io_parenteral_type)),cell(1,1,square_bracket_to_span(io.io_parenteral_name)),cell(1,1,io.io_parenteral_amount),cell(1,1,io.io_parenteral_absorb),cell(1,1,io.io_parenteral_carry_forward),cell(1,1,io.io_parenteral_remark),
  cell(1,1,io.io_oral_name),cell(1,1,io.io_oral_amount),cell(1,1,io.io_oral_absorb),cell(1,1,io.io_oral_carry_forward),cell(1,1,io.io_oral_remark),
  cell(1,1,output(io.io_output_type)),cell(1,1,io.io_output_amount),cell(1,1,io.io_output_remark),cell(1,1,io.user_name)
)
