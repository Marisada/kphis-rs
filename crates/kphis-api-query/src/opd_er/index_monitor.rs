...
pub async fn insert_index_monitors_only(action_id: u32, opd_er_order_master_id: u32, index_monitors_only: &[IndexMonitorOnly], pool: &Pool<MySql>, kphis_extra: &str) -> Result<MySqlQueryResult, AppError> {
