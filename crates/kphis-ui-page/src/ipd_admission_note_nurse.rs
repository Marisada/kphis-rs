...
impl IpdAdmissionNoteNursePage {
    ...
    fn finalized(page: Rc<Self>) -> IpdNurseAdmissionNote {
        IpdNurseAdmissionNote {
            ...
            info_patient: str_some(&page.info_patient.lock_ref()),
            info_parent: str_some(&page.info_parent.lock_ref()),
            info_spouse: str_some(&page.info_spouse.lock_ref()),
            info_child: str_some(&page.info_child.lock_ref()),
            info_relatives: str_some(&page.info_relatives.lock_ref()),
            info_sender: str_some(&page.info_sender.lock_ref()),
            chief_complaints: str_some(&page.chief_complaints.lock_ref()),
            medical_history: str_some(&page.medical_history.lock_ref()),
            vs_admit: str_some(&page.vs_admit.lock_ref()),
            concious: str_some(&page.concious.lock_ref()),
            normal_breath: str_some(&page.normal_breath.lock_ref()),
            kussmaul: str_some(&page.kussmaul.lock_ref()),
            tachypnea: str_some(&page.tachypnea.lock_ref()),
            dyspnea: str_some(&page.dyspnea.lock_ref()),
            apnea: str_some(&page.apnea.lock_ref()),
            tube: str_some(&page.tube.lock_ref()),
            normal_hr: str_some(&page.normal_hr.lock_ref()),
            arregular: str_some(&page.arregular.lock_ref()),
            weakness: str_some(&page.weakness.lock_ref()),
            arrhythmia: str_some(&page.arrhythmia.lock_ref()),
            chestpain: str_some(&page.chestpain.lock_ref()),
            pacemaker: str_some(&page.pacemaker.lock_ref()),
            cardio_other: str_some(&page.cardio_other.lock_ref()),
            cardio_other_text: str_some(&page.cardio_other_text.lock_ref()),
            normal_cir: str_some(&page.normal_cir.lock_ref()),
            pale: str_some(&page.pale.lock_ref()),
            cyanosis: str_some(&page.cyanosis.lock_ref()),
            generalized_edema: str_some(&page.generalized_edema.lock_ref()),
            localized_edema: str_some(&page.localized_edema.lock_ref()),
            localized_edema_text: str_some(&page.localized_edema_text.lock_ref()),
            pitting_edema: str_some(&page.pitting_edema.lock_ref()),
            pitting_edema_text: str_some(&page.pitting_edema_text.lock_ref()),
            circulation_orther: str_some(&page.circulation_orther.lock_ref()),
            circulation_orther_text: str_some(&page.circulation_orther_text.lock_ref()),
            normal_skin: str_some(&page.normal_skin.lock_ref()),
            dry: str_some(&page.dry.lock_ref()),
            bruise: str_some(&page.bruise.lock_ref()),
            erythema: str_some(&page.erythema.lock_ref()),
            abscess: str_some(&page.abscess.lock_ref()),
            joudice: str_some(&page.joudice.lock_ref()),
            skin_other: str_some(&page.skin_other.lock_ref()),
            skin_other_text: str_some(&page.skin_other_text.lock_ref()),
            pain: str_some(&page.pain.lock_ref()),
            location: str_some(&page.location.lock_ref()),
            pain_charac: str_some(&page.pain_charac.lock_ref()),
            pain_charac_text: str_some(&page.pain_charac_text.lock_ref()),
            pain_score: str_some(&page.pain_score.lock_ref()),
            normal_behav: str_some(&page.normal_behav.lock_ref()),
            agitate: str_some(&page.agitate.lock_ref()),
            aggressive: str_some(&page.aggressive.lock_ref()),
            depression: str_some(&page.depression.lock_ref()),
            madness: str_some(&page.madness.lock_ref()),
            behaviour_other: str_some(&page.behaviour_other.lock_ref()),
            behaviour_other_text: str_some(&page.behaviour_other_text.lock_ref()),
            normal_emotional: str_some(&page.normal_emotional.lock_ref()),
            angry: str_some(&page.angry.lock_ref()),
            moody: str_some(&page.moody.lock_ref()),
            anxiety: str_some(&page.anxiety.lock_ref()),
            fear: str_some(&page.fear.lock_ref()),
            emotional_other: str_some(&page.emotional_other.lock_ref()),
            emotional_other_text: str_some(&page.emotional_other_text.lock_ref()),
            no_anxiety: str_some(&page.no_anxiety.lock_ref()),
            study: str_some(&page.study.lock_ref()),
            family: str_some(&page.family.lock_ref()),
            economy: str_some(&page.economy.lock_ref()),
            habitation: str_some(&page.habitation.lock_ref()),
            illness: str_some(&page.illness.lock_ref()),
            spiritual_no: str_some(&page.spiritual_no.lock_ref()),
            spiritual_back_home: str_some(&page.spiritual_back_home.lock_ref()),
            spiritual_need_family: str_some(&page.spiritual_need_family.lock_ref()),
            spiritual_other: str_some(&page.spiritual_other.lock_ref()),
            spiritual_other_text: str_some(&page.spiritual_other_text.lock_ref()),
            spiritual_cant_rated: str_some(&page.spiritual_cant_rated.lock_ref()),
            spiritual_cant_rated_text: str_some(&page.spiritual_cant_rated_text.lock_ref()),
            no_mental_state: str_some(&page.no_mental_state.lock_ref()),
            no_mental_state_text: str_some(&page.no_mental_state_text.lock_ref()),
            education: str_some(&page.education.lock_ref()),
            education_result: str_some(&page.education_result.lock_ref()),
            occupation: str_some(&page.occupation.lock_ref()),
            income: str_some(&page.income.lock_ref()),
            self_value: str_some(&page.self_value.lock_ref()),
            person_family: str_some(&page.person_family.lock_ref()),
            neighbor: str_some(&page.neighbor.lock_ref()),
            assistant_other: str_some(&page.assistant_other.lock_ref()),
            assistant_other_text: str_some(&page.assistant_other_text.lock_ref()),
            assistant_occupation: str_some(&page.assistant_occupation.lock_ref()),
            clinic: str_some(&page.clinic.lock_ref()),
            buy_medicine: str_some(&page.buy_medicine.lock_ref()),
            no_risk: str_some(&page.no_risk.lock_ref()),
            smoking: str_some(&page.smoking.lock_ref()),
            smoke_year: str_some(&page.smoke_year.lock_ref()),
            smoke_frequency: str_some(&page.smoke_frequency.lock_ref()),
            smoke_stopped: str_some(&page.smoke_stopped.lock_ref()),
            alcohol: str_some(&page.alcohol.lock_ref()),
            alc_year: str_some(&page.alc_year.lock_ref()),
            alc_frequency: str_some(&page.alc_frequency.lock_ref()),
            alc_stopped: str_some(&page.alc_stopped.lock_ref()),
            medication_used: str_some(&page.medication_used.lock_ref()),
            med_name: str_some(&page.med_name.lock_ref()),
            med_year: str_some(&page.med_year.lock_ref()),
            med_frequency: str_some(&page.med_frequency.lock_ref()),
            med_stopped: str_some(&page.med_stopped.lock_ref()),
            diet_regular: str_some(&page.diet_regular.lock_ref()),
            diet_spec: str_some(&page.diet_spec.lock_ref()),
            nutrition_risk: str_some(&page.nutrition_risk.lock_ref()),
            loss_appetite: str_some(&page.loss_appetite.lock_ref()),
            dysphagia: str_some(&page.dysphagia.lock_ref()),
            loss_gustation: str_some(&page.loss_gustation.lock_ref()),
            denture: str_some(&page.denture.lock_ref()),
            nutrition_risk_other: str_some(&page.nutrition_risk_other.lock_ref()),
            nutrition_risk_other_text: str_some(&page.nutrition_risk_other_text.lock_ref()),
            normal_urine: str_some(&page.normal_urine.lock_ref()),
            dysuria: str_some(&page.dysuria.lock_ref()),
            incontinence: str_some(&page.incontinence.lock_ref()),
            staining: str_some(&page.staining.lock_ref()),
            hematuria: str_some(&page.hematuria.lock_ref()),
            catheter: str_some(&page.catheter.lock_ref()),
            normal_feces: str_some(&page.normal_feces.lock_ref()),
            constipation: str_some(&page.constipation.lock_ref()),
            diarrhea: str_some(&page.diarrhea.lock_ref()),
            bowel_incontinence: str_some(&page.bowel_incontinence.lock_ref()),
            hemorrhoid: str_some(&page.hemorrhoid.lock_ref()),
            colostomy: str_some(&page.colostomy.lock_ref()),
            activity1: str_some(&page.activity1.lock_ref()),
            activity2: str_some(&page.activity2.lock_ref()),
            activity3: str_some(&page.activity3.lock_ref()),
            activity4: str_some(&page.activity4.lock_ref()),
            o_p_use: str_some(&page.o_p_use.lock_ref()),
            sleep_per_day: str_some(&page.sleep_per_day.lock_ref()),
            sleep_hour: str_some(&page.sleep_hour.lock_ref()),
            sleep_problems: str_some(&page.sleep_problems.lock_ref()),
            sleep_problems_detail: str_some(&page.sleep_problems_detail.lock_ref()),
            sleep_med_name: str_some(&page.sleep_med_name.lock_ref()),
            sleep_med_name_detail: str_some(&page.sleep_med_name_detail.lock_ref()),
            cognitive: str_some(&page.cognitive.lock_ref()),
            memory: str_some(&page.memory.lock_ref()),
            memory_detail: str_some(&page.memory_detail.lock_ref()),
            hearing: str_some(&page.hearing.lock_ref()),
            hearing_detail: str_some(&page.hearing_detail.lock_ref()),
            eartone: str_some(&page.eartone.lock_ref()),
            vision: str_some(&page.vision.lock_ref()),
            vision_detail: str_some(&page.vision_detail.lock_ref()),
            vision_eyeglasses: str_some(&page.vision_eyeglasses.lock_ref()),
            vision_contactlens: str_some(&page.vision_contactlens.lock_ref()),
            speech: str_some(&page.speech.lock_ref()),
            speech_detail: str_some(&page.speech_detail.lock_ref()),
            self_image: str_some(&page.self_image.lock_ref()),
            self_image_detail: str_some(&page.self_image_detail.lock_ref()),
            self_activity: str_some(&page.self_activity.lock_ref()),
            self_activity_detail: str_some(&page.self_activity_detail.lock_ref()),
            sickness_effect: str_some(&page.sickness_effect.lock_ref()),
            sickness_family: str_some(&page.sickness_family.lock_ref()),
            sickness_occupation: str_some(&page.sickness_occupation.lock_ref()),
            sickness_education: str_some(&page.sickness_education.lock_ref()),
            sickness_other: str_some(&page.sickness_other.lock_ref()),
            sickness_other_text: str_some(&page.sickness_other_text.lock_ref()),
            period: str_some(&page.period.lock_ref()),
            period_normal: str_some(&page.period_normal.lock_ref()),
            period_disorders: str_some(&page.period_disorders.lock_ref()),
            period_lmp: str_some(&page.period_lmp.lock_ref()),
            period_menopause: str_some(&page.period_menopause.lock_ref()),
            breast: str_some(&page.breast.lock_ref()),
            breast_disorders: str_some(&page.breast_disorders.lock_ref()),
            consult: str_some(&page.consult.lock_ref()),
            seclude: str_some(&page.seclude.lock_ref()),
            medication: str_some(&page.medication.lock_ref()),
            medication_detail: str_some(&page.medication_detail.lock_ref()),
            religion: str_some(&page.religion.lock_ref()),
            coping_stress_other: str_some(&page.coping_stress_other.lock_ref()),
            coping_stress_other_detail: str_some(&page.coping_stress_other_detail.lock_ref()),
            belief_sickness_behave: str_some(&page.belief_sickness_behave.lock_ref()),
            belief_sickness_age: str_some(&page.belief_sickness_age.lock_ref()),
            belief_sickness_destiny: str_some(&page.belief_sickness_destiny.lock_ref()),
            belief_sickness_other: str_some(&page.belief_sickness_other.lock_ref()),
            belief_sickness_other_text: str_some(&page.belief_sickness_other_text.lock_ref()),
            belief_believe: str_some(&page.belief_believe.lock_ref()),
            belief_believe_text: str_some(&page.belief_believe_text.lock_ref()),
            religious_activity: str_some(&page.religious_activity.lock_ref()),
            religious_activity_text: str_some(&page.religious_activity_text.lock_ref()),
            // not save
