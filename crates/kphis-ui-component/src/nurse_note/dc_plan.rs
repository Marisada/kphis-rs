    ...
    fn finalized(&self) -> Option<DischargePlanSave> {
        ...
        if let Some(dx_id) = dx_id_opt {
            Some(DischargePlanSave {
                ...
                dc_type_ok: str_some(&self.dc_type_ok.lock_ref()),
                dc_type_refer: str_some(&self.dc_type_refer.lock_ref()),
                dc_type_other: str_some(&self.dc_type_other.lock_ref()),
                dc_symptom: str_some(&self.dc_symptom.lock_ref()),
                inst_none: str_some(&self.inst_none.lock_ref()),
                inst_foley: str_some(&self.inst_foley.lock_ref()),
                inst_ett: str_some(&self.inst_ett.lock_ref()),
                inst_tt: str_some(&self.inst_tt.lock_ref()),
                inst_ng: str_some(&self.inst_ng.lock_ref()),
                inst_other: str_some(&self.inst_other.lock_ref()),
                with_drug: str_some(&self.with_drug.lock_ref()),
                with_appoint: str_some(&self.with_appoint.lock_ref()),
                with_cert: str_some(&self.with_cert.lock_ref()),
                with_other: str_some(&self.with_other.lock_ref()),
                appoint_date: date_8601(&self.appoint_date.lock_ref()),
                appoint_time: time_8601(&self.appoint_time.lock_ref()),
                appoint_place: str_some(&self.appoint_place.lock_ref()),
                appoint_for: str_some(&self.appoint_for.lock_ref()),
                refer_to: str_some(&self.refer_to.lock_ref()),
                dx_text: str_some(&self.dx_text.lock_ref()),
                dx_patient_ok: str_some(&self.dx_patient_ok.lock_ref()),
                dx_relatives_ok: str_some(&self.dx_relatives_ok.lock_ref()),
                dx_other: str_some(&self.dx_other.lock_ref()),
                dx_doctor: str_some(&self.dx_doctor.lock_ref()),
                dx_datetime: datetime_8601(&self.dx_datetime.lock_ref()),
                med_text: str_some(&self.med_text.lock_ref()),
                med_patient_ok: str_some(&self.med_patient_ok.lock_ref()),
                med_relatives_ok: str_some(&self.med_relatives_ok.lock_ref()),
                med_other: str_some(&self.med_other.lock_ref()),
                med_doctor: str_some(&self.med_doctor.lock_ref()),
                med_datetime: datetime_8601(&self.med_datetime.lock_ref()),
                env_text: str_some(&self.env_text.lock_ref()),
                env_patient_ok: str_some(&self.env_patient_ok.lock_ref()),
                env_relatives_ok: str_some(&self.env_relatives_ok.lock_ref()),
                env_other: str_some(&self.env_other.lock_ref()),
                env_doctor: str_some(&self.env_doctor.lock_ref()),
                env_datetime: datetime_8601(&self.env_datetime.lock_ref()),
                tx_text: str_some(&self.tx_text.lock_ref()),
                tx_patient_ok: str_some(&self.tx_patient_ok.lock_ref()),
                tx_relatives_ok: str_some(&self.tx_relatives_ok.lock_ref()),
                tx_other: str_some(&self.tx_other.lock_ref()),
                tx_doctor: str_some(&self.tx_doctor.lock_ref()),
                tx_datetime: datetime_8601(&self.tx_datetime.lock_ref()),
                health_text: str_some(&self.health_text.lock_ref()),
                health_patient_ok: str_some(&self.health_patient_ok.lock_ref()),
                health_relatives_ok: str_some(&self.health_relatives_ok.lock_ref()),
                health_other: str_some(&self.health_other.lock_ref()),
                health_doctor: str_some(&self.health_doctor.lock_ref()),
                health_datetime: datetime_8601(&self.health_datetime.lock_ref()),
                out_text: str_some(&self.out_text.lock_ref()),
                out_patient_ok: str_some(&self.out_patient_ok.lock_ref()),
                out_relatives_ok: str_some(&self.out_relatives_ok.lock_ref()),
                out_other: str_some(&self.out_other.lock_ref()),
                out_doctor: str_some(&self.out_doctor.lock_ref()),
                out_datetime: datetime_8601(&self.out_datetime.lock_ref()),
                diet_text: str_some(&self.diet_text.lock_ref()),
                diet_patient_ok: str_some(&self.diet_patient_ok.lock_ref()),
                diet_relatives_ok: str_some(&self.diet_relatives_ok.lock_ref()),
                diet_other: str_some(&self.diet_other.lock_ref()),
                diet_doctor: str_some(&self.diet_doctor.lock_ref()),
