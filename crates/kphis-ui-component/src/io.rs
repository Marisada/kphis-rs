        ...
        if let Some(patient) = page.patient.get_cloned() {
            ...
            if valid {
                ...
                let save = IoShift {
                    ...
                    io_date,
                    io_time,
                    io_parenteral_type: str_some(&page.io_parenteral_type.lock_ref()),
                    io_parenteral_name: str_some(&page.io_parenteral_name.lock_ref()),
                    ...
                    io_parenteral_remark: str_some(&page.io_parenteral_remark.lock_ref()),
                    io_oral_name: str_some(&page.io_oral_name.lock_ref()),
                    ...
                    io_oral_remark: str_some(&page.io_oral_remark.lock_ref()),
                    io_output_type: str_some(&page.io_output_type.lock_ref()),
                    io_output_amount: page.io_output_amount.lock_ref().parse::<i32>().ok(),
                    io_output_remark: str_some(&page.io_output_remark.lock_ref()),
                    version: page.version.get(),
                    user_name: str_some(&page.user_name.lock_ref()).or(app.doctor_name()),
                    entryposition: str_some(&page.entryposition.lock_ref()).or(app.doctor_entryposition()),
                    shift_date: None,
                    shift: None,
                    an,
