...
impl VitalSignFormCpn {
    ...
    fn finalized(&self) -> VitalSignSave {
        ...
        VitalSignSave {
            ...
            urine: str_some(&self.urine.lock_ref()),
            catheter: str_some(&self.catheter.lock_ref()),
            urine_amount: self.urine_amount.lock_ref().parse::<u32>().ok(),
            urine_duration: self.urine_duration.lock_ref().parse::<u32>().ok(),
            feces: str_some(&self.feces.lock_ref()),
            ...
            braden: str_some(&self.braden.lock_ref()),
            pain: self.pain.lock_ref().parse::<i32>().ok(),
            eye: self.eye.lock_ref().parse::<i32>().ok(),
            verbal: str_some(&self.verbal.lock_ref()),
            ...
            had_name: str_some(&self.had_name.lock_ref()),
            had_drop: str_some(&self.had_drop.lock_ref()),
            hct: Decimal::from_str_exact(&self.hct.lock_ref()).ok(),
            dtx: str_some(&self.dtx.lock_ref()),
            bl: Decimal::from_str_exact(&self.bl.lock_ref()).ok(),
            mcb: Decimal::from_str_exact(&self.mcb.lock_ref()).ok(),
            suction: str_some(&self.suction.lock_ref()),
            nb: str_some(&self.nb.lock_ref()),
            ...
            ventilator_name: str_some(&self.ventilator_name.lock_ref()),
            mode: str_some(&self.mode.lock_ref()),
            ...
            lr_pos: str_some(&self.lr_pos.lock_ref()),
            ...
            diet: str_some(&self.diet.lock_ref()),
            barthel_index: str_some(&self.barthel_index.lock_ref()),
            aggression_oas: str_some(&self.aggression_oas.lock_ref()),
            alcohol_ciwa: str_some(&self.alcohol_ciwa.lock_ref()),
            alcohol_aws: str_some(&self.alcohol_aws.lock_ref()),
            amphetamine_awq: str_some(&self.amphetamine_awq.lock_ref()),
            ...
            depress_2q: str_some(&self.depress_2q.lock_ref()),
            depress_9q: str_some(&self.depress_9q.lock_ref()),
            suicide_8q: str_some(&self.suicide_8q.lock_ref()),
        }
    }
