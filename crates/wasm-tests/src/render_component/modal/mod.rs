...
async fn test_aside_resizer_cpn() {
    let app = new_app();
    let modal = kphis_ui_component::modal::consult_form::ConsultForm::new(
        Mutable::new(Some(Rc::new(kphis_model::patient_info::PatientInfo::demo()))),
        Some(1),
        kphis_ui_component::modal::consult_form::ConsultFormMode::View,
    );
...
async fn test_index_plan_action_form_cpn_oneday_plan() {
    let app = new_app();
    let modal = kphis_ui_component::modal::index_plan_action_form::IndexPlanActionForm::new(
        1,
        Some(1),
        Some(1),
        Mutable::new(Some(Rc::new(kphis_model::patient_info::PatientInfo::demo()))),
        kphis_ui_component::modal::index_plan_action_form::OrderType::OneDay,
        kphis_ui_component::modal::index_plan_action_form::FormType::Plan,
...
async fn test_index_plan_action_form_cpn_oneday_action() {
    ...
    let modal = kphis_ui_component::modal::index_plan_action_form::IndexPlanActionForm::new(
        ...
        Mutable::new(Some(Rc::new(kphis_model::patient_info::PatientInfo::demo()))),
        kphis_ui_component::modal::index_plan_action_form::OrderType::OneDay,
        kphis_ui_component::modal::index_plan_action_form::FormType::Action,
        Mutable::new(String::from("nurse")),
    );
    let dom = kphis_ui_component::modal::index_plan_action_form::IndexPlanActionForm::render_modal(modal, Mutable::new(None), None, app);
    replace_body(dom).await;
...
async fn test_index_plan_action_form_cpn_oneday_monitor() {
    ...
    let modal = kphis_ui_component::modal::index_plan_action_form::IndexPlanActionForm::new(
        ...
        Mutable::new(Some(Rc::new(kphis_model::patient_info::PatientInfo::demo()))),
        kphis_ui_component::modal::index_plan_action_form::OrderType::OneDay,
        kphis_ui_component::modal::index_plan_action_form::FormType::Monitor,
        Mutable::new(String::from("nurse")),
    );
    let dom = kphis_ui_component::modal::index_plan_action_form::IndexPlanActionForm::render_modal(modal, Mutable::new(None), None, app);
    replace_body(dom).await;
...
async fn test_index_plan_action_form_cpn_cont_plan() {
    ...
    let modal = kphis_ui_component::modal::index_plan_action_form::IndexPlanActionForm::new(
        ...
        Some(1),
        Mutable::new(Some(Rc::new(kphis_model::patient_info::PatientInfo::demo()))),
        kphis_ui_component::modal::index_plan_action_form::OrderType::Continuous,
        kphis_ui_component::modal::index_plan_action_form::FormType::Plan,
        Mutable::new(String::from("nurse")),
    );
    let dom = kphis_ui_component::modal::index_plan_action_form::IndexPlanActionForm::render_modal(modal, Mutable::new(None), None, app);
...
async fn test_pre_order_select_cpn_pre() {
    let app = new_app();
    let modal = kphis_ui_component::modal::pre_order_select::PreOrderSelect::new(
        kphis_ui_component::modal::pre_order_select::PreOrderType::PreOrder(String::new()),
        "1",
        kphis_ui_component::modal::pre_order_preview::ToOrderType::Order,
    );
    let dom = kphis_ui_component::modal::pre_order_select::PreOrderSelect::render_modal(modal.clone(), Mutable::new(Some(modal)), None, None, app);
    replace_body(dom).await;
}
