...
async fn test_vital_sign_data_cpn_gen() {
    let app = new_app();
    let cpn = kphis_ui_component::vital_sign::vital_sign_data::VitalSignDataCpn::new(
        Mutable::new(Some(Rc::new(kphis_model::patient_info::PatientInfo::demo()))),
        Mutable::new(vec![Rc::new(kphis_model::vital_sign::VitalSign::demo())]),
        Mutable::new(String::from("2023-12-31")),
        Mutable::new(String::from("2023-12-31")),
        Mutable::new(kphis_model::vital_sign::VsMode::General),
    );
...
async fn test_vital_sign_data_cpn_labour() {
    ...
    let cpn = kphis_ui_component::vital_sign::vital_sign_data::VitalSignDataCpn::new(
        ...
        Mutable::new(String::from("2023-12-31")),
        Mutable::new(String::from("2023-12-31")),
        Mutable::new(kphis_model::vital_sign::VsMode::Labour),
    );
    let dom = kphis_ui_component::vital_sign::vital_sign_data::VitalSignDataCpn::render(Mutable::new(1), Mutable::new(false), cpn, app);
    replace_body(dom).await;
}
...
async fn test_vital_sign_data_cpn_neuro() {
    ...
    let cpn = kphis_ui_component::vital_sign::vital_sign_data::VitalSignDataCpn::new(
        ...
        Mutable::new(String::from("2023-12-31")),
        Mutable::new(String::from("2023-12-31")),
        Mutable::new(kphis_model::vital_sign::VsMode::Neuro),
    );
    let dom = kphis_ui_component::vital_sign::vital_sign_data::VitalSignDataCpn::render(Mutable::new(1), Mutable::new(false), cpn, app);
    replace_body(dom).await;
}
...
async fn test_vital_sign_data_cpn_psychia() {
    ...
    let cpn = kphis_ui_component::vital_sign::vital_sign_data::VitalSignDataCpn::new(
        ...
        Mutable::new(String::from("2023-12-31")),
        Mutable::new(String::from("2023-12-31")),
        Mutable::new(kphis_model::vital_sign::VsMode::Psychia),
    );
    let dom = kphis_ui_component::vital_sign::vital_sign_data::VitalSignDataCpn::render(Mutable::new(1), Mutable::new(false), cpn, app);
    replace_body(dom).await;
}
...
async fn test_vital_sign_data_cpn() {
    let app = new_app();
    let cpn = kphis_ui_component::vital_sign::vital_sign_form::VitalSignFormCpn::new(
        Mutable::new(Some(Rc::new(kphis_model::patient_info::PatientInfo::demo()))),
        Some(Rc::new(kphis_model::vital_sign::VitalSign::demo())),
        app.clone(),
    );
