...
pub async fn get_ipd_progress_note_bundle(params: &ProgressNoteParams, intern_roles: &[String], pool: &Pool<MySql>, hosxp: &str, kphis: &str, kphis_extra: &str) -> Result<Vec<ProgressNote>, AppError> {
