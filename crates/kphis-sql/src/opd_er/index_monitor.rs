...
// FROM kphis_extra.opd_er_nurse_index_monitor m
...
pub fn select_index_monitor_only(kphis_extra: &str) -> String {
    [
        "SELECT * FROM ",kphis_extra,".opd_er_nurse_index_monitor WHERE action_id=? ORDER BY monitor_id;"
    ].concat()
}

// INSERT INTO kphis_extra.opd_er_nurse_index_monitor (action_id,opd_er_order_master_id,monitor_datetime,monitor_doctor,monitor_abnormal,monitor_result,monitor_remark,create_user,create_datetime,update_user,update_datetime,version)
// VALUES (?,?,?,?,?,?,?,?,NOW(),?,NOW(),1);
/// action_id, opd_er_order_master_id, monitor_datetime, monitor_doctor, monitor_abnormal, monitor_result, monitor_remark, loginname, loginname
pub fn insert_index_monitor(kphis_extra: &str) -> String {
    [
        "INSERT INTO ",kphis_extra,".opd_er_nurse_index_monitor (action_id,opd_er_order_master_id,monitor_datetime,monitor_doctor,monitor_abnormal,monitor_result,monitor_remark",TABLE_CREATE_COLUMNS,") \
        VALUES (?,?,?,?,?,?,?",TABLE_CREATE_PREPARED,");"
    ].concat()
}

pub fn insert_index_monitors_only(action_id: u32, opd_er_order_master_id: u32, index_monitors_only: &[IndexMonitorOnly], kphis_extra: &str) -> String {
...
// UPDATE kphis_extra.opd_er_nurse_index_monitor
...
// DELETE FROM kphis_extra.opd_er_nurse_index_monitor WHERE monitor_id=?;
/// monitor_id
