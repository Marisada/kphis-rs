...
//        FROM kphis_extra.ipd_dc_plan_med_item mi LEFT JOIN kphis_extra.ipd_dc_plan_tmp_med tm ON tm.med_id=mi.med_id
...
//        FROM kphis_extra.ipd_dc_plan_env_item ei LEFT JOIN kphis_extra.ipd_dc_plan_tmp_env te ON te.env_id=ei.env_id
//        WHERE ei.dc_plan_id=dp.dc_plan_id) AS envs,
// 	(SELECT GROUP_CONCAT(CONCAT(tt.tx_id,'^',tt.tx_text) ORDER BY ti.tx_id ASC SEPARATOR '|')
//        FROM kphis_extra.ipd_dc_plan_tx_item ti LEFT JOIN kphis_extra.ipd_dc_plan_tmp_tx tt ON tt.tx_id=ti.tx_id
...
//        FROM kphis_extra.ipd_dc_plan_diet_item di LEFT JOIN kphis_extra.ipd_dc_plan_tmp_diet td ON td.diet_id=di.diet_id
//        WHERE di.dc_plan_id=dp.dc_plan_id) AS diets
// FROM kphis_extra.ipd_dc_plan dp
...
pub fn select_dc_plan_only(kphis_extra: &str) -> String {
    [
        "SELECT * FROM ",kphis_extra,".ipd_dc_plan WHERE an=? ORDER BY dc_plan_id ASC;"
    ].concat()
}
...
pub fn select_dc_plan_med_item_only(kphis_extra: &str) -> String {
    [
        "SELECT * FROM ",kphis_extra,".ipd_dc_plan_med_item WHERE dc_plan_id=? ORDER BY med_item_id ASC;"
    ].concat()
}
...
pub fn select_dc_plan_env_item_only(kphis_extra: &str) -> String {
    [
        "SELECT * FROM ",kphis_extra,".ipd_dc_plan_env_item WHERE dc_plan_id=? ORDER BY env_item_id ASC;"
    ].concat()
}
...
pub fn select_dc_plan_tx_item_only(kphis_extra: &str) -> String {
    [
        "SELECT * FROM ",kphis_extra,".ipd_dc_plan_tx_item WHERE dc_plan_id=? ORDER BY tx_item_id ASC;"
    ].concat()
}
...
pub fn select_dc_plan_diet_item_only(kphis_extra: &str) -> String {
    [
        "SELECT * FROM ",kphis_extra,".ipd_dc_plan_diet_item WHERE dc_plan_id=? ORDER BY diet_item_id ASC;"
    ].concat()
}

// INSERT INTO kphis_extra.ipd_dc_plan_med_item (dc_plan_id,med_id,create_user,create_datetime,update_user,update_datetime,version)
...
pub fn insert_med_items(
    ...
    [
        "INSERT INTO ",kphis_extra,".ipd_dc_plan_med_item (dc_plan_id,med_id",TABLE_CREATE_COLUMNS,") VALUES ",&med
    ].concat()
}
...
pub fn insert_med_items_only(
    ...
    [
        "INSERT INTO ",kphis_extra,".ipd_dc_plan_med_item (dc_plan_id,med_id",TABLE_CREATE_COLUMNS,") \
        VALUES ",&values
    ].concat()
}

// INSERT INTO kphis_extra.ipd_dc_plan_env_item (dc_plan_id,env_id,create_user,create_datetime,update_user,update_datetime,version)
...
pub fn insert_env_items(
    ...
    [
        "INSERT INTO ",kphis_extra,".ipd_dc_plan_env_item (dc_plan_id,env_id",TABLE_CREATE_COLUMNS,") VALUES ",&env
    ].concat()
}
...
pub fn insert_env_items_only(
    ...
    [
        "INSERT INTO ",kphis_extra,".ipd_dc_plan_env_item (dc_plan_id,env_id",TABLE_CREATE_COLUMNS,") \
        VALUES ",&values
    ].concat()
}

// INSERT INTO kphis_extra.ipd_dc_plan_tx_item (dc_plan_id,tx_id,create_user,create_datetime,update_user,update_datetime,version)
...
pub fn insert_tx_items(
    ...
    [
        "INSERT INTO ",kphis_extra,".ipd_dc_plan_tx_item (dc_plan_id,tx_id",TABLE_CREATE_COLUMNS,") VALUES ",&tx
    ].concat()
}
...
pub fn insert_tx_items_only(
    ...
    [
        "INSERT INTO ",kphis_extra,".ipd_dc_plan_tx_item (dc_plan_id,tx_id",TABLE_CREATE_COLUMNS,") \
        VALUES ",&values
    ].concat()
}

// INSERT INTO kphis_extra.ipd_dc_plan_diet_item (dc_plan_id,diet_id,create_user,create_datetime,update_user,update_datetime,version)
...
pub fn insert_diet_items(
    ...
    [
        "INSERT INTO ",kphis_extra,".ipd_dc_plan_diet_item (dc_plan_id,diet_id",TABLE_CREATE_COLUMNS,") VALUES ",&diet
    ].concat()
}
...
pub fn insert_diet_items_only(
    ...
    [
        "INSERT INTO ",kphis_extra,".ipd_dc_plan_diet_item (dc_plan_id,diet_id",TABLE_CREATE_COLUMNS,") \
        VALUES ",&values
    ].concat()
}

// DELETE FROM kphis_Extra.ipd_dc_plan WHERE dc_plan_id = ?
/// dc_plan_id, version
pub fn delete_dc_plan(kphis_extra: &str) -> String {
    [
        "DELETE FROM ",kphis_extra,".ipd_dc_plan WHERE dc_plan_id=? AND version=?;"
    ].concat()
}

// DELETE FROM kphis_extra.ipd_dc_plan_med_item WHERE dc_plan_id=? AND version=?;
/// dc_plan_id, version
...
// DELETE FROM kphis_extra.ipd_dc_plan_env_item WHERE dc_plan_id=? AND version=?;
/// dc_plan_id, version
...
// DELETE FROM kphis_extra.ipd_dc_plan_tx_item WHERE dc_plan_id=? AND version=?;
/// dc_plan_id, version
...
// DELETE FROM kphis_extra.ipd_dc_plan_diet_item WHERE dc_plan_id=? AND version=?;
/// dc_plan_id, version
